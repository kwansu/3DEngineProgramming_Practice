...
cCollider_Box::cCollider_Box()
{
	...
	m_aIndex.push_back(0), m_aIndex.push_back(2), m_aIndex.push_back(1);
	m_aIndex.push_back(0), m_aIndex.push_back(6), m_aIndex.push_back(2);

	m_aIndex.push_back(0), m_aIndex.push_back(1), m_aIndex.push_back(4);
	m_aIndex.push_back(4), m_aIndex.push_back(1), m_aIndex.push_back(5);

	m_aIndex.push_back(1), m_aIndex.push_back(2), m_aIndex.push_back(5);
	m_aIndex.push_back(2), m_aIndex.push_back(3), m_aIndex.push_back(5);

	m_aIndex.push_back(4), m_aIndex.push_back(5), m_aIndex.push_back(3);
	m_aIndex.push_back(4), m_aIndex.push_back(3), m_aIndex.push_back(7);

	m_aIndex.push_back(2), m_aIndex.push_back(6), m_aIndex.push_back(7);
	m_aIndex.push_back(2), m_aIndex.push_back(7), m_aIndex.push_back(3);

	m_aIndex.push_back(4), m_aIndex.push_back(7), m_aIndex.push_back(6);
	m_aIndex.push_back(0), m_aIndex.push_back(4), m_aIndex.push_back(6);
}
