...
bool cCollider_Sphere::CollisionCheckOfPoint(const D3DXVECTOR3* pvPos) const
{
	return false;
}


bool cCollider_Sphere::CollisionCheckOfRay(const cRay* pRay)
{
	return false;
}


bool cCollider_Sphere::CollisionCheckOfCollider(iCollider* pOther)
{
	return false;
}
