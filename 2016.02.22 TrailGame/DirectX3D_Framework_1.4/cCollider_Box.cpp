...
bool cCollider_Box::IsCollisionAsRay(cRay ray, const D3DXMATRIXA16 * pmatInverse)
{
	if (pmatInverse)
...
bool cCollider_Box::CalcAxisRange(float fAxisPos, float fAxisDir, OUT stRange &rangeAxis)
{
